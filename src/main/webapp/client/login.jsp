      ...
      <div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg space-y-6">
        ...
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-600">
            Or
            <a href="${pageContext.request.contextPath}/signup" class="font-medium text-blue-600 hover:text-blue-700">
        ...
        <form action="${pageContext.request.contextPath}/login" method="POST" class="space-y-5">
          ...
          <div>
            ...
            <input id="email" name="email" type="email" required autocomplete="email"
              class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:ring-blue-400 focus:border-blue-400 sm:text-sm"
          ...
          <!-- Submit -->
          <button type="submit"
            class="w-full py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-150 font-medium flex items-center justify-center space-x-2">
