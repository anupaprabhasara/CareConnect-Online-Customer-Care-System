...
<head>
  <meta charset="UTF-8">
  <title>Responses | CareConnect</title>
...
<section class="py-16 bg-blue-50 min-h-[360px]">
  <div class="max-w-7xl mx-auto px-6">
    <div class="flex items-center justify-between mb-8">
      <h2 class="text-3xl font-bold text-blue-600">Responses to Ticket #00${ticketId}</h2>
            ...
            <div class="border border-blue-200 rounded-md p-4 bg-blue-50">
              ...
              <div class="text-right">
                <a href="${pageContext.request.contextPath}/feedback?action=create&responseId=${response.responseId}"
                   class="inline-flex items-center gap-2 text-sm px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
