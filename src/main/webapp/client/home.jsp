...
<body>
  ...
  <!-- Hero Section -->
  <section class="relative bg-blue-50 h-[30rem] flex items-center justify-center text-center">
    <div class="absolute inset-0 bg-cover bg-center opacity-50" style="background-image: url('https://www.zf.com/products/media/automotive/cv/cv_campaigns/na/WABCO_Customer_Care_Center_shutterstock_image_Header_crop2_5_2_2048px.jpg');"></div>
    <div class="absolute inset-0 bg-blue-200 bg-opacity-70"></div>

    <div class="relative z-10 px-6 max-w-3xl">
      <h1 class="text-4xl md:text-5xl font-bold text-blue-700 mb-4">Support That Cares</h1>
      <p class="text-lg md:text-xl text-gray-800 mb-6">CareConnect helps you manage support tickets, communicate with agents, and ensure customer satisfaction in one place.</p>
      <div class="flex flex-col md:flex-row justify-center gap-4">
        <a href="${pageContext.request.contextPath}/ticket?action=create"
           class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition shadow">
          <i class="fas fa-ticket-alt mr-2"></i> Submit Ticket
        </a>
        <a href="${pageContext.request.contextPath}/ticket"
           class="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-100 transition shadow">
  ...
  <section class="py-20 bg-white">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
        ...
        <div>
          <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <i class="fas fa-reply text-2xl text-blue-600"></i>
          </div>
  ...
  <section class="bg-blue-600 py-12 text-white text-center">
    <div class="container mx-auto px-4">
      ...
      <a href="${pageContext.request.contextPath}/ticket"
         class="inline-block px-8 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-blue-100 transition">
