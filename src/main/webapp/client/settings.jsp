...
<div class="max-w-7xl mx-auto my-12 bg-white p-10 rounded-2xl shadow-md border border-blue-200">
  <h2 class="text-3xl font-bold text-blue-600 mb-8">Update Your Profile</h2>
      ...
      <div class="space-y-6">
        <div>
          ...
          <input type="text" name="full_name" value="${user.fullName}" required
                 class="w-full px-4 py-2 border border-blue-300 bg-blue-50 rounded-md focus:ring-2 focus:ring-blue-400">
        </div>
        <div>
