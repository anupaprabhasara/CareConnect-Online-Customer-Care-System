        ...
        <form action="${pageContext.request.contextPath}/signup" method="POST" class="space-y-5" onsubmit="return validateForm()">
          ...
          <div>
            ...
            <input id="full_name" name="full_name" type="text" required
              class="mt-1 block w-full px-4 py-2 border border-blue-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          ...
          <div>
            <button id="signupBtn" type="submit" disabled
              class="w-full flex justify-center items-center space-x-2 px-4 py-2 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-blue-400">
