...
<head>
  <meta charset="UTF-8">
  <title>Edit Ticket | CareConnect</title>
...
<body>
  ...
  <section class="bg-blue-50 py-20">
    <div class="max-w-7xl mx-auto px-6">
      <div class="bg-white rounded-2xl shadow-lg p-10 border border-blue-200">
        <div class="mb-8 text-center">
          <h2 class="text-3xl font-bold text-blue-600 mb-2">Edit Support Ticket</h2>
        ...
        <form action="${pageContext.request.contextPath}/ticket" method="post" class="space-y-6">
          ...
          <div>
            ...
            <input type="text" id="subject" name="subject" value="${ticket.subject}" required
              class="w-full px-4 py-2 border border-blue-300 rounded-lg bg-blue-50 focus:ring-2 focus:ring-blue-400 focus:outline-none placeholder-gray-500">
          </div>
          ...
          <div>
            ...
            <textarea id="description" name="description" rows="5" required
              class="w-full px-4 py-2 border border-blue-300 rounded-lg bg-blue-50 focus:ring-2 focus:ring-blue-400 focus:outline-none placeholder-gray-500">${ticket.description}</textarea>
          </div>
          ...
          <div>
            ...
            <select id="category" name="category" required
              class="w-full px-4 py-2 border border-blue-300 rounded-lg bg-blue-50 focus:ring-2 focus:ring-blue-400 focus:outline-none">
