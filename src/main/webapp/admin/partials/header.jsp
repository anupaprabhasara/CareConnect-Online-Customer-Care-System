...
<header class="flex justify-between items-center p-4 bg-blue-600 shadow-sm">
  <h2 class="text-xl font-bold text-white">${pageTitle}</h2>
  <div class="flex items-center space-x-4">
    <div class="text-right text-sm">
      <p class="text-white font-semibold">${sessionScope.fullName}</p>
      <p class="text-blue-100 text-xs">${sessionScope.email}</p>
    </div>
    <img
      src="https://ui-avatars.com/api/?name=${sessionScope.fullName}&background=2563eb&color=fff"
