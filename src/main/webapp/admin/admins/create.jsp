...
<head>
  ...
  <title>CareConnect | Create Admin</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
</head>

<body class="bg-gradient-to-br from-teal-50 via-white to-blue-100 min-h-screen text-gray-800 flex">
      ...
      <form action="${pageContext.request.contextPath}/admin/admin" method="POST" class="bg-white shadow-lg rounded-lg p-8 w-full">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" id="fullName" name="fullName" required
                class="w-full px-4 py-2 rounded-lg border border-blue-300 bg-blue-50 text-gray-800 focus:ring-2 focus:ring-blue-400 focus:outline-none">
            </div>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="password" id="password" name="password" required
                class="w-full px-4 py-2 mb-2 rounded-lg border border-blue-300 bg-blue-50 text-gray-800 focus:ring-2 focus:ring-blue-400 focus:outline-none"
        ...
        <div class="mt-8 flex justify-end">
          <button id="submitButton" type="submit"
            class="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition"
            disabled>
