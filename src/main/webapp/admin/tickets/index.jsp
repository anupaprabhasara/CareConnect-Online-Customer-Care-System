...
<head>
  ...
  <title>CareConnect | Ticket Management</title>
      ...
      <div class="flex justify-end">
        <div class="relative w-full md:w-1/3">
          <input id="search" type="text" placeholder="Search tickets..."
                 class="w-full pl-10 pr-4 py-2 rounded-lg bg-white border border-blue-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-gray-800">
                ...
                <c:forEach var="ticket" items="${tickets}">
                  <tr class="border-b border-blue-100 hover:bg-blue-50">
                    ...
                    <td class="px-6 py-4">
                      <form method="post" action="${pageContext.request.contextPath}/admin/ticket">
                        ...
                        <select name="status" onchange="this.form.submit()"
                                class="px-2 py-1 rounded border border-blue-300 bg-blue-50 text-sm">
                    ...
                    <td class="px-6 py-4 text-center space-x-3">
                      <a href="${pageContext.request.contextPath}/admin/response?action=create&ticketId=${ticket.ticketId}" class="text-blue-600 hover:text-blue-700">
